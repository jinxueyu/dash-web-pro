    ...
    init: function () {
        ...
        !function () {
            ...
            var e = document.getElementById("kt_charts_widget_7_chart"), t = parseInt(KTUtil.css(e, "height")),
                ...
                n = KTUtil.getCssVariableValue("--bs-light-success"), d = KTUtil.getCssVariableValue("--bs-primary"),
                c = KTUtil.getCssVariableValue("--bs-light-primary");
            e && new ApexCharts(e, {
                ...
                colors: [r, l, d],
                grid: {borderColor: o, strokeDashArray: 4, yaxis: {lines: {show: !0}}},
                markers: {colors: [i, n, c], strokeColor: [r, l, d], strokeWidth: 3}
            }).render()
        }(), function () {
            ...
            e && new ApexCharts(e, {
                ...
                dataLabels: {enabled: !1},
                fill: {type: "solid", opacity: 1},
                stroke: {curve: "smooth", show: !0, width: 2, colors: [r, l, d]},
                xaxis: {
                    x: 0,
                    offsetX: 0,
                    offsetY: 0,
                ...
                markers: {colors: [r, l, d], strokeColor: [r, l, d], strokeWidth: 3}
            }).render()
        }(), function () {
            ...
            [].slice.call(o).map((function (o) {
                e = o.getAttribute("data-kt-color"), t = parseInt(KTUtil.css(o, "height")), a = KTUtil.getCssVariableValue("--bs-" + e), new ApexCharts(o, {
                    ...
                    chart: {fontFamily: "inherit", type: "bar", height: t, toolbar: {show: !1}},
                    plotOptions: {bar: {horizontal: !1, columnWidth: ["50%"], endingShape: "rounded", borderRadius: 4}},
                    legend: {show: !1},
                    dataLabels: {enabled: !1},
                    stroke: {show: !0, width: 2, colors: ["transparent"]},
                    xaxis: {
            ...
            theme: "snow"
        }), d = document.querySelector("#kt_widget_5_load_more_btn"), c = document.querySelector("#kt_widget_5"), d && d.addEventListener("click", (function (e) {
            e.preventDefault(), d.setAttribute("data-kt-indicator", "on"), setTimeout((function () {
                d.removeAttribute("data-kt-indicator"), c.classList.remove("d-none"), d.classList.add("d-none"), KTUtil.scrollTo(c, 200)
            }), 2e3)
